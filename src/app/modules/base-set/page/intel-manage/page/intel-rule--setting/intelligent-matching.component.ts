...
@Component({
    selector: 'intelligent-matching',
    templateUrl: './intelligent-matching.component.html',
    styleUrls: [
        './intelligent-matching.component.css',
        '../../../base-set-common.css'
    ]
})

export class intelligentMatchingComponent implements OnInit {
    msgs: any;//提示弹窗
    KPIAssessment: string;//KPI下拉框双向绑定;
