    ...
    [
        {
            ...
            'children': [{
                'label': '北京市',
                'data': '100000',
                'children': [{'label': '东城区','data': '100010'}, {'label': '西城区','data': '100020'}, {'label': '崇文区'}, {'label': '宣武区'}, {'label': '朝阳区'}, {'label': '丰台区'}, {'label': '石景山区'}, {'label': '海淀区'}, {'label': '门头沟区'}, {'label': '房山区'}, {'label': '通州区'}, {'label': '顺义区'}, {'label': '昌平区'}, {'label': '大兴区'}, {'label': '怀柔区'}, {'label': '平谷区'}, {'label': '密云县'}, {'label': '延庆县'}]
            }]
        }
    ],
    [
        {
            ...
            'children': [{
                'label': '上海市',
                'data': 'Work Folder',
                'children': [{'label': '黄浦区'}, {'label': '崇明县'}, {'label': '卢湾区'}, {'label': '徐汇区'}, {'label': '长宁区'}, {'label': '静安区'}, {'label': '普陀区'}, {'label': '闸北区'}, {'label': '虹口区'}, {'label': '杨浦区'}, {'label': '闵行区'}, {'label': '宝山区'}, {'label': '嘉定区'}, {'label': '浦东新区'}, {'label': '金山区'}, {'label': '松江区'}, {'label': '青浦区'}, {'label': '南汇区'}, {'label': '奉贤区'}]
            }]
        }
    ],
    [
        {
            ...
            'children': [{
                'label': '天津市',
                'data': 'Work Folder',
                'children': [{'label': '和平区'}, {'label': '河东区'}, {'label': '宁河县'}, {'label': '静海县'}, {'label': '蓟县'}, {'label': '河西区'}, {'label': '南开区'}, {'label': '河北区'}, {'label': '红桥区'}, {'label': '塘沽区'}, {'label': '汉沽区'}, {'label': '大港区'}, {'label': '东丽区'}, {'label': '西青区'}, {'label': '津南区'}, {'label': '北辰区'}, {'label': '武清区'}, {'label': '宝坻区'}]
            }]
        }
    ],
    [
        {
            ...
            'children': [{
                'label': '重庆市',
                'data': 'Work Folder',
                'children': [{'label': '万州区'}, {'label': '涪陵区'}, {'label': '渝中区'}, {'label': '大渡口区'}, {'label': '江北区'}, {'label': '沙坪坝区'}, {'label': '九龙坡区'}, {'label': '南岸区'}, {'label': '北碚区'}, {'label': '万盛区'}, {'label': '双桥区'}, {'label': '渝北区'}, {'label': '巴南区'}, {'label': '黔江区'}, {'label': '长寿区'}, {'label': '江津市'}, {'label': '合川市'}, {'label': '永川市'}, {'label': '南川市'}, {'label': '綦江县'}, {'label': '潼南县'}, {'label': '铜梁县'}, {'label': '大足县'}, {'label': '荣昌县'}, {'label': '璧山县'}, {'label': '梁平县'}, {'label': '城口县'}, {'label': '丰都县'}, {'label': '垫江县'}, {'label': '武隆县'}, {'label': '忠县'}, {'label': '开县'}, {'label': '云阳县'}, {'label': '奉节县'}, {'label': '巫山县'}, {'label': '巫溪县'}, {'label': '石柱土家族自治县'}, {'label': '秀山土家族苗族自治县'}, {'label': '酉阳土家族苗族自治县'}, {'label': '彭水苗族土家族自治县'}]
            }]
        }
    ],
    [
        {
            ...
            'children': [{
                'label': '成都市',
                'data': 'Work Folder',
                'children': [{'label': '锦江区'}, {'label': '青羊区'}, {'label': '金牛区'}, {'label': '武侯区'}, {'label': '成华区'}, {'label': '龙泉驿区'}, {'label': '青白江区'}, {'label': '新都区'}, {'label': '温江县'}, {'label': '金堂县'}, {'label': '双流县'}, {'label': '郫县'}, {'label': '大邑县'}, {'label': '蒲江县'}, {'label': '新津县'}, {'label': '都江堰市'}, {'label': '彭州市'}, {'label': '邛崃市'}, {'label': '崇州市'}]
            },
                {
                    'label': '自贡市',
                    'data': 'Work Folder',
                    'children': [{'label': '自流井区'}, {'label': '贡井区'}, {'label': '大安区'}, {'label': '沿滩区'}, {'label': '荣县'}, {'label': '富顺县'}]
                },
                {
                    'label': '攀枝花市',
                    'data': 'Work Folder',
                ...
                },
                {
                    'label': '德阳市',
                    'data': 'Work Folder',
                    'children': [{'label': '旌阳区'}, {'label': '中江县'}, {'label': '罗江县'}, {'label': '广汉市'}, {'label': '什邡市'}, {'label': '绵竹市'}]
                },
                {
                    'label': '绵阳市',
                    'data': 'Work Folder',
                    'children': [{'label': '涪城区'}, {'label': '游仙区'}, {'label': '三台县'}, {'label': '盐亭县'}, {'label': '安县'}, {'label': '梓潼县'}, {'label': '北川羌族自治县'}, {'label': '平武县'}, {'label': '江油市'}]
                },
                {
                    'label': '广元市',
                    'data': 'Work Folder',
                    'children': [{'label': '市中区'}, {'label': '元坝区'}, {'label': '朝天区'}, {'label': '旺苍县'}, {'label': '青川县'}, {'label': '剑阁县'}, {'label': '苍溪县'}]
                },
                {
                    'label': '遂宁市',
                    'data': 'Work Folder',
                    'children': [{'label': '船山区'}, {'label': '安居区'}, {'label': '蓬溪县'}, {'label': '射洪县'}, {'label': '大英县'}]
                },
                {
                    'label': '内江市',
                    'data': 'Work Folder',
                    'children': [{'label': '市中区'}, {'label': '东兴区'}, {'label': '威远县'}, {'label': '资中县'}, {'label': '隆昌县'}]
                },
                {
                    'label': '乐山市',
                    'data': 'Work Folder',
                    'children': [{'label': '市中区'}, {'label': '沙湾区'}, {'label': '五通桥区'}, {'label': '金口河区'}, {'label': '犍为县'}, {'label': '井研县'}, {'label': '夹江县'}, {'label': '沐川县'}, {'label': '峨边彝族自治县'}, {'label': '马边彝族自治县'}, {'label': '峨眉山市'}]
                },
                {
                    'label': '南充市',
                    'data': 'Work Folder',
                    'children': [{'label': '顺庆区'}, {'label': '高坪区'}, {'label': '嘉陵区'}, {'label': '南部县'}, {'label': '营山县'}, {'label': '蓬安县'}, {'label': '仪陇县'}, {'label': '西充县'}, {'label': '阆中市'}]
                },
                {
                    'label': '眉山市',
                    'data': 'Work Folder',
                ...
                },
                {
                    'label': '宜宾市',
                    'data': 'Work Folder',
                    'children': [{'label': '翠屏区'}, {'label': '宜宾县'}, {'label': '南溪县'}, {'label': '江安县'}, {'label': '长宁县'}, {'label': '高县'}, {'label': '珙县'}, {'label': '筠连县'}, {'label': '兴文县'}, {'label': '屏山县'}]
                },
                {
                    'label': '广安市',
                    'data': 'Work Folder',
                    'children': [{'label': '广安区'}, {'label': '岳池县'}, {'label': '武胜县'}, {'label': '邻水县'}, {'label': '华莹市'}]
                },
                {
                    'label': '达州市',
                    'data': 'Work Folder',
                    'children': [{'label': '通川区'}, {'label': '达县'}, {'label': '宣汉县'}, {'label': '开江县'}, {'label': '大竹县'}, {'label': '渠县'}, {'label': '万源市'}]
                },
                {
                    'label': '雅安市',
                    'data': 'Work Folder',
                    'children': [{'label': '雨城区'}, {'label': '名山县'}, {'label': '荥经县'}, {'label': '汉源县'}, {'label': '石棉县'}, {'label': '天全县'}, {'label': '芦山县'}, {'label': '宝兴县'}]
                },
                {
                    'label': '资阳市',
                    'data': 'Work Folder',
                    'children': [{'label': '雁江区'}, {'label': '安岳县'}, {'label': '乐至县'}, {'label': '简阳市'}]
                },
                {
                    'label': '阿坝藏族羌族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '汶川县'}, {'label': '理县'}, {'label': '茂县'}, {'label': '松潘县'}, {'label': '九寨沟县'}, {'label': '金川县'}, {'label': '小金县'}, {'label': '黑水县'}, {'label': '马尔康县'}, {'label': '壤塘县'}, {'label': '阿坝县'}, {'label': '若尔盖县'}, {'label': '红原县'}]
                },
                {
                    'label': '甘孜藏族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '康定县'}, {'label': '泸定县'}, {'label': '丹巴县'}, {'label': '九龙县'}, {'label': '雅江县'}, {'label': '道孚县'}, {'label': '炉霍县'}, {'label': '甘孜县'}, {'label': '新龙县'}, {'label': '德格县'}, {'label': '白玉县'}, {'label': '石渠县'}, {'label': '色达县'}, {'label': '理塘县'}, {'label': '巴塘县'}, {'label': '乡城县'}, {'label': '稻城县'}, {'label': '得荣县'}]
                },
                {
                    'label': '凉山彝族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '西昌市'}, {'label': '木里藏族自治县'}, {'label': '盐源县'}, {'label': '德昌县'}, {'label': '会理县'}, {'label': '会东县'}, {'label': '宁南县'}, {'label': '普格县'}, {'label': '布拖县'}, {'label': '金阳县'}, {'label': '昭觉县'}, {'label': '喜德县'}, {'label': '冕宁县'}, {'label': '越西县'}, {'label': '甘洛县'}, {'label': '美姑县'}, {'label': '雷波县'}]
                },
            ]
        }
    ],
    [
        {
            ...
            'children': [{
                'label': '贵阳市',
                'data': 'Work Folder',
                'children': [{'label': '南明区'}, {'label': '云岩区'}, {'label': '花溪区'}, {'label': '乌当区'}, {'label': '白云区'}, {'label': '小河区'}, {'label': '开阳县'}, {'label': '息烽县'}, {'label': '修文县'}, {'label': '清镇市'}]
            },
                {
                    'label': '六盘水市',
                    'data': 'Work Folder',
                    'children': [{'label': '钟山区'}, {'label': '六枝特区'}, {'label': '水城县'}, {'label': '盘县'}]
                },
                {
                    'label': '遵义市',
                    'data': 'Work Folder',
                    'children': [{'label': '红花岗区'}, {'label': '汇川区'}, {'label': '遵义县'}, {'label': '桐梓县'}, {'label': '绥阳县'}, {'label': '正安县'}, {'label': '道真仡佬族苗族自治县'}, {'label': '务川仡佬族苗族自治县'}, {'label': '凤冈县'}, {'label': '湄潭县'}, {'label': '余庆县'}, {'label': '习水县'}, {'label': '赤水市'}, {'label': '仁怀市'}]
                },
                {
                    'label': '安顺市',
                    'data': 'Work Folder',
                    'children': [{'label': '西秀区'}, {'label': '平坝县'}, {'label': '普定县'}, {'label': '镇宁布依族苗族自治县'}, {'label': '关岭布依族苗族自治县'}, {'label': '紫云苗族布依族自治县'}]
                },
                {
                    'label': '铜仁地区',
                    'data': 'Work Folder',
                    'children': [{'label': '铜仁市'}, {'label': '江口县'}, {'label': '玉屏侗族自治县'}, {'label': '石阡县'}, {'label': '思南县'}, {'label': '印江土家族苗族自治县'}, {'label': '德江县'}, {'label': '沿河土家族自治县'}, {'label': '松桃苗族自治县'}, {'label': '万山特区'}]
                },
                {
                    'label': '黔西南布依族苗族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '兴义市'}, {'label': '兴仁县'}, {'label': '普安县'}, {'label': '晴隆县'}, {'label': '贞丰县'}, {'label': '望谟县'}, {'label': '册亨县'}, {'label': '安龙县'}]
                },
                {
                    'label': '毕节地区',
                    'data': 'Work Folder',
                    'children': [{'label': '毕节市'}, {'label': '大方县'}, {'label': '黔西县'}, {'label': '金沙县'}, {'label': '织金县'}, {'label': '纳雍县'}, {'label': '威宁彝族回族苗族自治县'}, {'label': '赫章县'}]
                },
                {
                    'label': '黔东南苗族侗族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '凯里市'}, {'label': '黄平县'}, {'label': '施秉县'}, {'label': '三穗县'}, {'label': '镇远县'}, {'label': '岑巩县'}, {'label': '天柱县'}, {'label': '锦屏县'}, {'label': '剑河县'}, {'label': '台江县'}, {'label': '黎平县'}, {'label': '榕江县'}, {'label': '从江县'}, {'label': '雷山县'}, {'label': '麻江县'}, {'label': '丹寨县'}]
                },
                {
                    'label': '黔南布依族苗族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '都匀市'}, {'label': '福泉市'}, {'label': '荔波县'}, {'label': '贵定县'}, {'label': '瓮安县'}, {'label': '独山县'}, {'label': '平塘县'}, {'label': '罗甸县'}, {'label': '长顺县'}, {'label': '龙里县'}, {'label': '惠水县'}, {'label': '三都水族自治县'}]
                }
            ]
        }
    ],
    [
        {
            ...
            'children': [{
                'label': '昆明市',
                'data': 'Work Folder',
                'children': [{'label': '五华区'}, {'label': '盘龙区'}, {'label': '官渡区'}, {'label': '西山区'}, {'label': '东川区'}, {'label': '呈贡县'}, {'label': '晋宁县'}, {'label': '富民县'}, {'label': '宜良县'}, {'label': '石林彝族自治县'}, {'label': '嵩明县'}, {'label': '禄劝彝族苗族自治县'}, {'label': '寻甸回族彝族自治县'}, {'label': '安宁市'}]
            },
                {
                    'label': '曲靖市',
                    'data': 'Work Folder',
                    'children': [{'label': '麒麟区'}, {'label': '马龙县'}, {'label': '陆良县'}, {'label': '师宗县'}, {'label': '罗平县'}, {'label': '富源县'}, {'label': '会泽县'}, {'label': '沾益县'}, {'label': '宣威市'}]
                },
                {
                    'label': '玉溪市',
                    'data': 'Work Folder',
                ...
                },
                {
                    'label': '保山市',
                    'data': 'Work Folder',
                    'children': [{'label': '隆阳区'}, {'label': '施甸县'}, {'label': '腾冲县'}, {'label': '龙陵县'}, {'label': '昌宁县'}]
                },
                {
                    'label': '昭通市',
                    'data': 'Work Folder',
                ...
                },
                {
                    'label': '丽江市',
                    'data': 'Work Folder',
                    'children': [{'label': '古城区'}, {'label': '玉龙纳西族自治县'}, {'label': '永胜县'}, {'label': '华坪县'}, {'label': '宁蒗彝族自治县'}]
                },
                {
                    'label': '思茅市',
                    'data': 'Work Folder',
                    'children': [{'label': '翠云区'}, {'label': '普洱哈尼族彝族自治县'}, {'label': '墨江哈尼族自治县'}, {'label': '景东彝族自治县'}, {'label': '景谷傣族彝族自治县'}, {'label': '镇沅彝族哈尼族拉祜族自治县'}, {'label': '江城哈尼族彝族自治县'}, {'label': '孟连傣族拉祜族佤族自治县'}, {'label': '澜沧拉祜族自治县'}, {'label': '西盟佤族自治县'}]
                },
                {
                    'label': '临沧市',
                    'data': 'Work Folder',
                ...
                },
                {
                    'label': '红河哈尼族彝族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '个旧市'}, {'label': '开远市'}, {'label': '蒙自县'}, {'label': '屏边苗族自治县'}, {'label': '建水县'}, {'label': '石屏县'}, {'label': '弥勒县'}, {'label': '泸西县'}, {'label': '元阳县'}, {'label': '红河县'}, {'label': '金平苗族瑶族傣族自治县'}, {'label': '绿春县'}, {'label': '河口瑶族自治县'}]
                },
                {
                    'label': '文山壮族苗族自治州',
                    'data': 'Work Folder',
                ...
                },
                {
                    'label': '大理白族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '大理市'}, {'label': '漾濞彝族自治县'}, {'label': '祥云县'}, {'label': '宾川县'}, {'label': '弥渡县'}, {'label': '南涧彝族自治县'}, {'label': '巍山彝族回族自治县'}, {'label': '永平县'}, {'label': '云龙县'}, {'label': '洱源县'}, {'label': '剑川县'}, {'label': '鹤庆县'}]
                },
                {
                    'label': '德宏傣族景颇族自治州',
                    'data': 'Work Folder',
                    'children': [{'label': '瑞丽市'}, {'label': '潞西市'}, {'label': '梁河县'}, {'label': '盈江县'}, {'label': '陇川县'}]
                },
                {
                    'label': '怒江傈僳族自治州',
                    'data': 'Work Folder',
    ...
    [
        {
            ...
            'children': [{
                ...
                },
                {
                    'label': '阿里地区',
                    'data': 'Work Folder',
                    'children': [{'label': '普兰县'}, {'label': '札达县'}, {'label': '噶尔县'}, {'label': '日土县'}, {'label': '革吉县'}, {'label': '改则县'}, {'label': '措勤县'}]
                },
                {
                    'label': '林芝地区',
                    'data': 'Work Folder',
    ...
    [
        {
            ...
            'children': [{
                'label': '郑州市',
                'data': 'Work Folder',
                'children': [{'label': '中原区'}, {'label': '二七区'}, {'label': '管城回族区'}, {'label': '金水区'}, {'label': '上街区'}, {'label': '邙山区'}, {'label': '中牟县'}, {'label': '巩义市'}, {'label': '荥阳市'}, {'label': '新密市'}, {'label': '新郑市'}, {'label': '登封市'}]
            }, {
                'label': '开封市',
                'data': 'Work Folder',
                'children': [{'label': '龙亭区'}, {'label': '顺河回族区'}, {'label': '鼓楼区'}, {'label': '南关区'}, {'label': '郊区'}, {'label': '杞县'}, {'label': '通许县'}, {'label': '尉氏县'}, {'label': '开封县'}, {'label': '兰考县'}]
            }, {
                'label': '洛阳市',
                'data': 'Work Folder',
                'children': [{'label': '老城区'}, {'label': '西工区'}, {'label': '廛河回族区'}, {'label': '涧西区'}, {'label': '吉利区'}, {'label': '洛龙区'}, {'label': '孟津县'}, {'label': '新安县'}, {'label': '栾川县'}, {'label': '嵩县'}, {'label': '汝阳县'}, {'label': '宜阳县'}, {'label': '洛宁县'}, {'label': '伊川县'}, {'label': '偃师市'}]
            }, {
                'label': '平顶山市',
                'data': 'Work Folder',
                'children': [{'label': '新华区'}, {'label': '卫东区'}, {'label': '石龙区'}, {'label': '湛河区'}, {'label': '宝丰县'}, {'label': '叶　县'}, {'label': '鲁山县'}, {'label': '郏县'}, {'label': '舞钢市'}, {'label': '汝州市'}]
            }, {
                'label': '安阳市',
                'data': 'Work Folder',
                'children': [{'label': '文峰区'}, {'label': '北关区'}, {'label': '殷都区'}, {'label': '龙安区'}, {'label': '安阳县'}, {'label': '汤阴县'}, {'label': '滑县'}, {'label': '内黄县'}, {'label': '林州市'}]
            }, {
                'label': '鹤壁市',
                'data': 'Work Folder',
                'children': [{'label': '鹤山区'}, {'label': '山城区'}, {'label': '淇滨区'}, {'label': '浚县'}, {'label': '淇县'}]
            }, {
                'label': '新乡市',
                'data': 'Work Folder',
                'children': [{'label': '红旗区'}, {'label': '卫滨区'}, {'label': '凤泉区'}, {'label': '牧野区'}, {'label': '新乡县'}, {'label': '获嘉县'}, {'label': '原阳县'}, {'label': '延津县'}, {'label': '封丘县'}, {'label': '长垣县'}, {'label': '卫辉市'}, {'label': '辉县市'}]
            }, {
                'label': '焦作市',
                'data': 'Work Folder',
                'children': [{'label': '解放区'}, {'label': '马村区'}, {'label': '山阳区'}, {'label': '修武县'}, {'label': '博爱县'}, {'label': '武陟县'}, {'label': '温　县'}, {'label': '济源市'}, {'label': '沁阳市'}, {'label': '孟州市'}]
            },
                {
                    'label': '濮阳市',
                    'data': 'Work Folder',
                    'children': [{'label': '华龙区'}, {'label': '清丰县'}, {'label': '南乐县'}, {'label': '范县'}, {'label': '台前县'}, {'label': '濮阳县'}]
                },
                {
                    'label': '许昌市',
                    'data': 'Work Folder',
                    'children': [{'label': '魏都区'}, {'label': '许昌县'}, {'label': '鄢陵县'}, {'label': '襄城县'}, {'label': '禹州}市'}, {'label': '长葛市'}]
                }, {
                    'label': '漯河市',
                    'data': 'Work Folder',
                    'children': [{'label': '源汇区'}, {'label': '郾城区'}, {'label': '召陵区'}, {'label': '舞阳县'}, {'label': '临颍县'}]
                }, {
                    'label': '三门峡市',
                    'data': 'Work Folder',
                    'children': [{'label': '湖滨区'}, {'label': '渑池县'}, {'label': '陕县'}, {'label': '卢氏县'}, {'label': '义马市'}, {'label': '灵宝市'}]
                }, {
                    'label': '南阳市',
                    'data': 'Work Folder',
                    'children': [{'label': '宛城区'}, {'label': '卧龙区'}, {'label': '南召县'}, {'label': '方城县'}, {'label': '西峡县'}, {'label': '镇平县'}, {'label': '内乡县'}, {'label': '淅川县'}, {'label': '社旗县'}, {'label': '唐河县'}, {'label': '新野县'}, {'label': '桐柏县'}, {'label': '邓州市'}]
                }, {
                    'label': '商丘市',
                    'data': 'Work Folder',
                    'children': [{'label': '梁园区'}, {'label': '睢阳区'}, {'label': '民权县'}, {'label': '睢县'}, {'label': '宁陵县'}, {'label': '柘城县'}, {'label': '虞城县'}, {'label': '夏邑县'}, {'label': '永城市'}]
                }, {
                    'label': '信阳市',
                    'data': 'Work Folder',
                    'children': [{'label': '师河区'}, {'label': '平桥区'}, {'label': '罗山县'}, {'label': '光山县'}, {'label': '新县'}, {'label': '商城县'}, {'label': '固始县'}, {'label': '潢川县'}, {'label': '淮滨县'}, {'label': '息县'}]
                }, {
                    'label': '周口市',
                    'data': 'Work Folder',
                    'children': [{'label': '川汇区'}, {'label': '扶沟县'}, {'label': '西华县'}, {'label': '商水县'}, {'label': '沈丘县'}, {'label': '郸城县'}, {'label': '淮阳县'}, {'label': '太康县'}, {'label': '鹿邑县'}, {'label': '项城市'}]
                }, {
                    'label': '驻马店市',
                    'data': 'Work Folder',
                    'children': [{'label': '驿城区'}, {'label': '西平县'}, {'label': '上蔡县'}, {'label': '平舆县'}, {'label': '正阳县'}, {'label': '确山县'}, {'label': '泌阳县'}, {'label': '汝南县'}, {'label': '遂平县'}, {'label': '新蔡县'}]
                }
            ]
        }
    ],
    [
        {
            ...
            'children': [{
                'label': '武汉市',
                'data': 'Work Folder',
                'children': [{'label': '江岸区'}, {'label': '江汉区'}, {'label': '乔口区'}, {'label': '汉阳区'}, {'label': '武昌区'}, {'label': '青山区'}, {'label': '洪山区'}, {'label': '东西湖区'}, {'label': '汉南区'}, {'label': '蔡甸区'}, {'label': '江夏区'}, {'label': '黄陂区'}, {'label': '新洲区'}]
            }, {
                'label': '黄石市',
                'data': 'Work Folder',
                'children': [{'label': '黄石港区'}, {'label': '西塞山区'}, {'label': '下陆区'}, {'label': '铁山区'}, {'label': '阳新县'}, {'label': '大冶市'}]
            }, {
                'label': '十堰市',
                'data': 'Work Folder',
                'children': [{'label': '茅箭区'}, {'label': '张湾区'}, {'label': '郧县'}, {'label': '郧西县'}, {'label': '竹山县'}, {'label': '竹溪县'}, {'label': '房县'}, {'label': '丹江口市'}]
            }, {
                'label': '宜昌市',
                'data': 'Work Folder',
                'children': [{'label': '西陵区'}, {'label': '伍家岗区'}, {'label': '点军区'}, {'label': '猇亭区'}, {'label': '夷陵区'}, {'label': '远安县'}, {'label': '兴山县'}, {'label': '秭归县'}, {'label': '长阳土家族自治县'}, {'label': '五峰土家族自治县'}, {'label': '宜都市'}, {'label': '当阳市'}, {'label': '枝江市'}]
            }, {
                'label': '襄樊市',
                'data': 'Work Folder',
                'children': [{'label': '襄城区'}, {'label': '樊城区'}, {'label': '襄阳区'}, {'label': '南漳县'}, {'label': '谷城县'}, {'label': '保康县'}, {'label': '老河口市'}, {'label': '枣阳市'}, {'label': '宜城市'}]
            }, {
                'label': '鄂州市',
                'data': 'Work Folder',
                'children': [{'label': '梁子湖区'}, {'label': '华容区'}, {'label': '鄂城区'}]
            }, {
                'label': '荆门市',
                'data': 'Work Folder',
                'children': [{'label': '东宝区'}, {'label': '掇刀区'}, {'label': '京山县'}, {'label': '沙洋县'}, {'label': '钟祥市'}]
            }, {
                'label': '孝感市',
                'data': 'Work Folder',
                'children': [{'label': '孝南区'}, {'label': '孝昌县'}, {'label': '大悟县'}, {'label': '云梦县'}, {'label': '应城市'}, {'label': '安陆市'}, {'label': '汉川市'}]
            }, {
                'label': '荆州市',
                'data': 'Work Folder',
                'children': [{'label': '沙市区'}, {'label': '荆州区'}, {'label': '公安县'}, {'label': '监利县'}, {'label': '江陵县'}, {'label': '石首市'}, {'label': '洪湖市'}, {'label': '松滋市'}]
            }, {
                'label': '黄冈市',
                'data': 'Work Folder',
                'children': [{'label': '黄州区'}, {'label': '团风县'}, {'label': '红安县'}, {'label': '罗田县'}, {'label': '英山县'}, {'label': '浠水县'}, {'label': '蕲春县'}, {'label': '黄梅县'}, {'label': '麻城市'}, {'label': '武穴市'}]
            }, {
                'label': '咸宁市',
                'data': 'Work Folder',
                'children': [{'label': '咸安区'}, {'label': '嘉鱼县'}, {'label': '通城县'}, {'label': '崇阳县'}, {'label': '通山县'}, {'label': '赤壁市'}]
            }, {
                'label': '随州市',
                'data': 'Work Folder',
                ...
                'label': '恩施土家族苗族自治州',
                'data': 'Work Folder',
                'children': [{'label': '恩施市'}, {'label': '利川市'}, {'label': '建始县'}, {'label': '巴东县'}, {'label': '宣恩县'}, {'label': '咸丰县'}, {'label': '来凤县'}, {'label': '鹤峰县'}]
            }, {
                'label': '省直辖行政单位',
                'data': 'Work Folder',
                'children': [{'label': '仙桃市'}, {'label': '潜江市'}, {'label': '天门市'}, {'label': '神农架林区'}]
            },
    ...
    [
        {
            ...
            'children': [{
                'label': '长沙市',
                'data': 'Work Folder',
                'children': [{'label': '芙蓉区'}, {'label': '天心区'}, {'label': '岳麓区'}, {'label': '开福区'}, {'label': '雨花区'}, {'label': '长沙县'}, {'label': '望城县'}, {'label': '宁乡县'}, {'label': '浏阳市'}]
            }, {
                'label': '株洲市',
                'data': 'Work Folder',
                'children': [{'label': '荷塘区'}, {'label': '芦淞区'}, {'label': '石峰区'}, {'label': '天元区'}, {'label': '株洲县'}, {'label': '攸县'}, {'label': '茶陵县'}, {'label': '炎陵县'}, {'label': '醴陵市'}]
            }, {
                'label': '湘潭市',
                'data': 'Work Folder',
                'children': [{'label': '雨湖区'}, {'label': '岳塘区'}, {'label': '湘潭县'}, {'label': '湘乡市'}, {'label': '韶山市'}]
            }, {
                'label': '衡阳市',
                'data': 'Work Folder',
                'children': [{'label': '珠晖区'}, '雁峰区', {'label': '石鼓区'}, {'label': '蒸湘区'}, {'label': '南岳区'}, {'label': '衡阳县'}, {'label': '衡南县'}, {'label': '衡山县'}, {'label': '衡东县'}, {'label': '祁东县'}, {'label': '耒阳市'}, {'label': '常宁市'}]
            }, {
                'label': '邵阳市',
                'data': 'Work Folder',
                'children': [{'label': '双清区'}, {'label': '大祥区'}, {'label': '北塔区'}, {'label': '邵东县'}, {'label': '新邵县'}, {'label': '邵阳县'}, {'label': '隆回县'}, {'label': '洞口县'}, {'label': '绥宁县'}, {'label': '新宁县'}, {'label': '城步苗族自治县'}, {'label': '武冈市'}]
            }, {
                'label': '岳阳市',
                'data': 'Work Folder',
                'children': [{'label': '岳阳楼区'}, {'label': '云溪区'}, {'label': '君山区'}, {'label': '岳阳县'}, {'label': '华容县'}, {'label': '湘阴县'}, {'label': '平江县'}, {'label': '汨罗市'}, {'label': '临湘市'}]
            }, {
                'label': '常德市',
                'data': 'Work Folder',
                'children': ['武陵区', '鼎城区', '安乡县', '汉寿县', '澧县', '临澧县', '桃源县', '石门县', '津市市']
            }, {
                'label': '张家界市',
                'data': 'Work Folder',
                ...
                'label': '郴州市',
                'data': 'Work Folder',
                'children': ['北湖区', '苏仙区', '桂阳县', '宜章县', '永兴县', '嘉禾县', '临武县', '汝城县', '桂东县', '安仁县', '资兴市']
            }, {
                'label': '永州市',
                'data': 'Work Folder',
                'children': ['芝山区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县']
            }, {
                'label': '怀化市',
                'data': 'Work Folder',
                'children': ['鹤城区', '中方县', '沅陵县', '辰溪县', '溆浦县', '会同县', '麻阳苗族自治县', '新晃侗族自治县', '芷江侗族自治县', '靖州苗族侗族自治县', '通道侗族自治县', '洪江市']
            }, {
                'label': '娄底市',
                'data': 'Work Folder',
