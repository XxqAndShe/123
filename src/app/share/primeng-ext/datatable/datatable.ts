    ...
    template: `
        <ng-template ngFor let-col [ngForOf]="columns" let-lastCol="last">
            <th #headerCell [ngStyle]="col.style" [class]="col.styleClass"
                [style.display]="col.hidden ? 'none' : 'table-cell'" (click)="dt.sort($event,col)"
                ...
                (dragleave)="dt.onColumnDragleave($event)" (drop)="dt.onColumnDrop($event)"
                ...
                <input [attr.type]="col.filterType"
                       ...
                       [attr.placeholder]="col.filterPlaceholder" *ngIf="col.filter&&!col.filterTemplate"
                ...
                <p-dtCheckbox *ngIf="col.selectionMode=='multiple'" (onChange)="dt.toggleRowsWithCheckbox($event)"
                ...
                <ng-template ngFor let-col [ngForOf]="columns" let-colIndex="index">
                    <td #cell *ngIf="!dt.rowGroupMode || (dt.rowGroupMode == 'subheader') ||
                        ...
                        <p-dtRadioButton *ngIf="col.selectionMode=='single'"
                                         ...
                                         [checked]="dt.isSelected(rowData)"></p-dtRadioButton>
            ...
            <tr *ngIf="dt.expandableRows && dt.isRowExpanded(rowData)">
                <td [attr.colspan]="dt.visibleColumns().length">
                    <p-rowExpansionLoader [rowData]="rowData"
                                          [template]="dt.rowExpansionTemplate"></p-rowExpansionLoader>
                </td>
            </tr>
        </ng-template>
        ...
        <div #scrollBody class="ui-datatable-scrollable-body" [ngStyle]="{'width': width,'max-height':dt.scrollHeight}">
            <div #scrollTableWrapper style="position:relative" [ngStyle]="{'height':virtualTableHeight}">
                <table #scrollTable [class]="dt.tableStyleClass" [ngStyle]="dt.tableStyle"
                    ...
                    <tbody
                        [ngClass]="{'ui-datatable-data ui-widget-content': true, 'ui-datatable-hoverable-rows': (dt.rowHover||dt.selectionMode)}"
