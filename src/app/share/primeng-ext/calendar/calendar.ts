/**
 * Created by giscafer on 2017-08-01.
 */
    ...
    template: `
        <span [ngClass]="{'ui-calendar':true,'ui-calendar-w-btn':showIcon}" [ngStyle]="style" [class]="styleClass">
            ...
            <div #datepicker class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"
                [ngClass]="{'ui-datepicker-inline':inline,'ui-shadow':!inline,'ui-state-disabled':disabled,'ui-datepicker-timeonly':timeOnly,'ui-datepicker-time':showTime}" 
                ...
                [ngClass]="{'ui-datepicker-header-time':showTime}"
                ...
                <div>
                  ...
                  [ngClass]="{'calendar-time':showTime}"
                   *ngIf="!timeOnly && (overlayVisible || inline)">
                    <thead>
                        <tr>
                        ...
                        <tr *ngFor="let week of dates">
                            <td *ngFor="let date of week" [ngClass]="{'ui-datepicker-other-month ui-state-disabled':date.otherMonth,
                                ...
                                <a class="ui-state-default" href="#" *ngIf="date.otherMonth ? showOtherMonths : true" 
                                    ...
                                    (click)="onDateSelect($event,date)" (dblclick)="onDblPickerClick($event)">{{date.day}}</a>
                            </td>
                        </tr>
                    </tbody>
                    </table>
                 <table class="ui-time-panel" (click)="chooseHours($event,'h')" *ngIf="showTime"> 
                            <thead>
                                <tr colspan="5"  class="bgc-color"> <th>小时</th></tr>
                            </thead>
                                <tr>
                                <td [ngClass]="{'selected':currentHour==0}">00</td>
                                <td [ngClass]="{'selected':currentHour==1}">01</td>
                                <td [ngClass]="{'selected':currentHour==2}">02</td>
                                <td [ngClass]="{'selected':currentHour==3}">03</td>
                                <td [ngClass]="{'selected':currentHour==4}">04</td>
                                </tr><tr>
                                <td [ngClass]="{'selected':currentHour==5}">05</td>
                                <td [ngClass]="{'selected':currentHour==6}">06</td>
                                <td [ngClass]="{'selected':currentHour==7}">07</td>
                                <td [ngClass]="{'selected':currentHour==8}">08</td>
                                <td [ngClass]="{'selected':currentHour==9}">09</td>
                                </tr><tr>
                                <td [ngClass]="{'selected':currentHour==10}">10</td>
                                <td [ngClass]="{'selected':currentHour==11}">11</td>
                                <td [ngClass]="{'selected':currentHour==12}">12</td>
                                <td [ngClass]="{'selected':currentHour==13}">13</td>
                                <td [ngClass]="{'selected':currentHour==14}">14</td>
                                </tr><tr>
                                <td [ngClass]="{'selected':currentHour==15}">15</td>
                                <td [ngClass]="{'selected':currentHour==16}">16</td>
                                <td [ngClass]="{'selected':currentHour==17}">17</td>
                                <td [ngClass]="{'selected':currentHour==18}">18</td>
                                <td [ngClass]="{'selected':currentHour==19}">19</td>
                                </tr><tr>
                                <td [ngClass]="{'selected':currentHour==20}">20</td>
                                <td [ngClass]="{'selected':currentHour==21}">21</td>
                                <td [ngClass]="{'selected':currentHour==22}">22</td>
                                <td [ngClass]="{'selected':currentHour==23}">23</td>
                                </tr>
                    </table>
                    <table class="ui-time-panel ui-munitime-panel" (click)="chooseHours($event,'m')" *ngIf="showTime"> 
                            <thead>
                                <tr colspan="3" class="bgc-color"> <th>分钟</th></tr>
                            </thead>
                                <tr>
                                <td [ngClass]="{'selected':currentMinute==0}">00</td>
                                <td [ngClass]="{'selected':currentMinute==5}">05</td>
                                <td [ngClass]="{'selected':currentMinute==10}">10</td>
                                 </tr><tr>
                                <td [ngClass]="{'selected':currentMinute==15}">15</td>
                                <td [ngClass]="{'selected':currentMinute==20}">20</td>
                                <td [ngClass]="{'selected':currentMinute==25}">25</td>
                                 </tr><tr>
                                <td [ngClass]="{'selected':currentMinute==30}">30</td>
                                <td [ngClass]="{'selected':currentMinute==35}">35</td>
                                <td [ngClass]="{'selected':currentMinute==40}">40</td>
                                </tr><tr>
                                <td [ngClass]="{'selected':currentMinute==45}">45</td>
                                <td [ngClass]="{'selected':currentMinute==50}">50</td>
                                <td [ngClass]="{'selected':currentMinute==55}">55</td>
                                </tr>
                            </table>
                </div>
                <div class="ui-timepicker ui-widget-header ui-corner-all" *ngIf="showTime||timeOnly" (click)="timeClick($event)">
                    <div class="date-text-inline">
                        <span>{{dateText}}</span>
                    </div>
                    ...
                    <div class="close-btn" *ngIf="!inline">
                        <span  (click)="closeOverlayBtn($event,1)" class="cancel-btn">取消</span>
                        <span  (click)="closeOverlayBtn($event,2)">确定</span>
                    </div>
                </div>
...
export class Calendar implements AfterViewInit, AfterViewChecked, OnInit, OnDestroy, ControlValueAccessor {
    ...
    ngAfterViewInit() {
        ...
        // inline 界面扩展属性
        let date = new Date();
        this.dateText = date.getFullYear() + '-' + (date.getMonth() + 1) + '-' + date.getDate();
    }
    ...
    updateInputfield() {
        if (this.value) {
            ...
            // inline 界面扩展属性
            this.dateText = this.currentYear + '-' + (this.currentMonth + 1) + '-' + this.value.getDate();
        }
        else {
    ...
    closeOverlayBtn($event, type?: any) {
        this.closeOverlay = true;
        this.overlayVisible = false;
        if (type === 2) {
            for (let week of this.dates) {
                for (let date of week) {
                    if (date.today && !this.inputFieldValue) {
